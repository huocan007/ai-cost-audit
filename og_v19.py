"""OG Image v19 — orange up, blue down, green unchanged."""
...
# ═══ RIGHT SIDE: v19 — orange up, blue down, green unchanged ═══
node_font = ImageFont.truetype(FONT_BOLD, 14)

nodes_black = {
    "Cloud Asia":     (1059, 176),   # orange: up from 188
    "Western Cloud":  (1059, 278),   # blue: down from 263
    "Self-hosted":    (1059, 386),   # green: unchanged
}
for label, (nx, ny) in nodes_black.items():
    centered_text(draw, nx, ny, label, node_font, BLACK)

centered_text(draw, 368, 290, "Gateway", node_font, WHITE)
